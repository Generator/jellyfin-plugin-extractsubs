#!/usr/bin/env python3
"""Build and package Better Subtitle Extractor releases for Jellyfin 12.0+."""
...
PLUGIN_NAME = "Better Subtitle Extractor"
PLUGIN_DESC = "Extracts embedded subtitles."
PLUGIN_OVERVIEW = "Extracts embedded subtitles and attachments from video files."
PLUGIN_CATEGORY = "Subtitles"
PLUGIN_OWNER = "jellyfin"
PLUGIN_IMAGE_URL = "https://repo.jellyfin.org/releases/plugin/images/jellyfin-plugin-extractsubs.png"
...
def build_jellyfin_zip(
    ...
    zip_path = ARTIFACTS / f"Jellyfin.Plugin.SubtitleExtract.zip"
    dll = publish_dir / "Jellyfin.Plugin.SubtitleExtract.dll"
